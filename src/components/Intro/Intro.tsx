  ...
  return (
    <section className={styles.section}>
      <div className={classNames(utilStyles.containerLg, styles.grid)}>
        <div className={classNames(utilStyles.imgShadow, utilStyles.imgRound, styles.photo1)}>
          <Image
        ...
        <div className={classNames(utilStyles.imgShadow, utilStyles.imgRound, styles.photo2)}>
          <Image
